<template>
  <div id="eventSearchList">
    ...
    <el-row class="title">
      ...
      <el-col :span="14" style="text-align: left;padding-left: 150px;">事件</el-col>
    ...
    <el-row class="father_row" v-for="(list,index) in tableData" :key="index">
      ...
      <el-col :span="12" class="eventStyle" style="cursor: pointer" @click.native="eventContent(list)" v-html="replaceBr(list.eventRemark)"></el-col><!--eventName-->
      <el-col :span="4" class="sortStyle" style="text-align: center">{{list.calendarName}}</el-col>
      ...
      <el-row class="son_row" v-for="(lista,indexa) in list.events" :key="indexa">
        ...
        <el-col :span="8" v-if="indexa !== 0" style="min-height: 10px"></el-col>
        <el-col :span="8" v-else></el-col>
        <el-col :span="12" class="eventStyle" style="cursor: pointer" @click.native="eventContent(lista)" v-html="replaceBr(lista.eventRemark)"></el-col>
        <el-col :span="4" class="sortStyle" style="text-align: center">{{lista.calendarName}}</el-col>
      </el-row>
    </el-row>
  ...
  export default {
    ...
    computed: {
      ...
      watchCurrent () {
        if (this.$route.path !== '/calendar/searchEvent') {
          console.log('--------')
          if (new Date(this.startFormat).getTime() <= this.currentEvent && this.currentEvent <= new Date(this.endFormat).getTime()) {
            this.getEventsListBytimeSlot(this.currentEvent)
          } else {
            this.getEventsListBytimeSlot()
          }
