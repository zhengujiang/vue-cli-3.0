...
<script>
  ...
  export default {
    ...
    watch: {
      active: function (val) {
        this.$nextTick(() => {
          var heightBar = document.querySelector('.barContent').clientHeight - 100;
          this.contentHeight = heightBar;
          console.log(heightBar, val, this.contentHeight);
        });
    ...
    mounted() {
      this.$nextTick(() => {
        var heightBar = document.querySelector('.barContent').clientHeight - 100;
        this.contentHeight = heightBar;
        console.log(heightBar, this.contentHeight);
      });
    },
    methods: {
      getTeamDefault() {
      ...
      addEvent(obj, xEvent, fn) {
        ...
        wrap.onscroll = function () {
          ...
          // console.log('page=', _th.listPage, 'sort', _th.collectSort, 'maxpage=', Math.ceil(_th.collectTotal / _th.listRows))
        }
