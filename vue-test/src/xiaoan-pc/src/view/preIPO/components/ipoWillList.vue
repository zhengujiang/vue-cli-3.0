    ...
    <div class="content" v-loading="tableSreenLoading">
      <el-tabs v-model="activeName" @tab-click="handleClick" class="tabs-box">
        ...
        <el-tab-pane :key="'all'" class="v-tabs-item" label="全部" name="all">
          <!---->
          <v-tab-pane-will-item type="all" name="全部" @date-change="dateChange"></v-tab-pane-will-item>
        </el-tab-pane>
        <!---->
        <el-tab-pane :key="'sh'" class="v-tabs-item" label="沪主板" name="sh">
          <!---->
          <v-tab-pane-will-item type="sh" name="沪市主板" @date-change="dateChange"></v-tab-pane-will-item>
        </el-tab-pane>
        <!---->
        <el-tab-pane :key="'zx'" class="v-tabs-item" label="中小板" name="zx">
          <!---->
          <v-tab-pane-will-item type="zx" name="深市中小板" @date-change="dateChange"></v-tab-pane-will-item>
        </el-tab-pane>
        <!---->
        <el-tab-pane :key="'cy'" class="v-tabs-item" label="创业板" name="cy">
          <!---->
          <v-tab-pane-will-item type="cy" name="深市创业板" @date-change="dateChange"></v-tab-pane-will-item>
        </el-tab-pane>
        <!---->
        <el-tab-pane :key="'innovate'" class="v-tabs-item" label="试点创新企业" name="innovate">
          <!---->
          <v-tab-pane-will-item type="innovate" name="试点创新" @date-change="dateChange"></v-tab-pane-will-item>
        </el-tab-pane>
      </el-tabs>
    </div>
  </div>
...
<script>
  import VTabPaneWillItem from '../components/marketList/tabPaneWillItem'
  export default {
    name: "ipoRetrialList",
    components: {
      VTabPaneWillItem
