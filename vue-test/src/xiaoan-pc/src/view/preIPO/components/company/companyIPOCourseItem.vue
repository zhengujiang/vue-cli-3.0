<template>
  <el-card shadow="never" class="box-card" body-style="padding:0 16px" id="companyIPOCourseItem">
    <el-collapse v-model="activeName" @change="handleChange" accordion>
      <el-collapse-item :name="'all'">
        ...
        <div class="course-list vux-1px-tb">
          <div class="list-box" v-for="(item, index) in companyData">
            <div class="title">
              <span class="row middle">{{typeCourse[item.type].name}}</span>
            </div>
            <div class="content-desc">
              <ul class="desc-box">
                <li class="" v-for="(list) in item.children">
