  ...
  <div id="ipo-retrial">
    <div class="box-header">
      <div class="content">
        <div class="list">
          <div class="row text">
            <div class="font-size-16 name"><span>IPO在审公司统计</span></div>
          </div>
          <div class="row btns">
    ...
    <div class="ipo-retrial-content" :class="{'is-background': $route.meta.check == 'overview'}">
  ...
  export default {
    ...
    methods: {
      checkChange(val) {
        ...
        if (val) {
          // true
          link = '/ipo/retrial/overview'
        } else {
          // false list
          link = '/ipo/retrial/list'
        }
        if (this.$route.query.active) {
          this.$router.replace({path: link, query: {active: this.$route.query.active}});
        } else {
