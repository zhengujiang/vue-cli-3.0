<template>
  ...
  <div id="companyQuestionItem" class="company-question">
    <div class="header vux-1px-b">
      <div class="row title">过去30天回答数最多的公司</div>
      <div class="row r-pagination text">
        <router-link to="/investor/leaderboard/brief?tab=ANSWER" target="_blank">
    ...
    <table class="company-table">
      <tr v-for="(item,index) of tableData">
        ...
        <td class="number">{{item.answerCount}}</td>
      </tr>
    </table>
  </div>
</template>
