<template>
  ...
  <div v-loading="vLoading">
    ...
    <div id="marketData" class="marketData">行情数据</div>
  </div>
</template>

<script>
  export default {
    name: "marketForCompany",
    data() {
      return {
        vLoading: true,
        ...
        echartPicData: [
          {
            "title": "1日", "bottomShow": "true"
          }, {
            "title": "1个月", "bottomShow": ""
          }, {
            "title": "3个月", "bottomShow": ""
          }, {
            "title": "6个月", "bottomShow": ""
          }, {
            "title": "本年至今", "bottomShow": ""
          }, {
            "title": "1年", "bottomShow": ""
          }, {
            "title": "2年", "bottomShow": ""
    ...
    methods: {
      ...
      getStockTimeKLineData() {
        ...
        this.$http({
          ...
          if (res.data.returnCode == 1 || res.data.returnObject) {
            this.xyaxiData = res.data.returnObject.Data
            let dateTime0 = new Date(this.xyaxiData[0].dateTime.replace(/-/g, '/'))
