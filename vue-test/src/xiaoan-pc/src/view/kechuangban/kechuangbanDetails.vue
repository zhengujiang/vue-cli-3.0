      ...
      <el-row :gutter="15">
        <el-col :span="18">
          <div class="details-box print">
            ...
            <!--pdf-->
            <div class="details-content" :class="{isScreen: isScreen}" v-if="contentSort == 'pdf'">
  ...
  export default {
    ...
    created() {
      ...
      if (this.$route.query.id) {
        this.getDetails(this.$route.query.id, this.$route.query.type);
      }
    },
    methods: {
      //
      ...
      getDetails(id, type) {
        ...
        let urlType = '';
        type ? urlType = 'getStibDetailsFromDB' : urlType = 'getStibDetails'
        //
        this.$http({
          methods: 'GET',
          url: this.$api.kechuangban[urlType],
          params: {
            id: id,
            userId: this.userId
          }
          ...
          if (res.data.returnCode == 1 || res.data.returnCode == 200) {
            this.contentDetail = res.data.returnObject.data;
            this.contentDetail.type = 1;
            ...
            console.log(this.contentDetail.type)
