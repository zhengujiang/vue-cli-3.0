<template>
    <div class="calendar">
        ...
        <table cellpadding="5" v-touch:left="moveStart" v-touch:right="moveEnd">
            <thead>
            <tr>
...
<style scoped>
    ...
    /*@s 修改代码*/
    /*.calendar td:not(.disabled).selected.red {*/
    /*background-color: #ea6151;*/
    /*border-radius: 5px;*/
    /*color: white;*/
    /*}*/
    /*.calendar td:not(.disabled).selected.red .text {*/
    /*color: white;*/
    /*}*/
    .calendar td .td-box {
    ...
    .calendar td:not(.disabled).selected .td-box {
        border: 2px solid #5e7a88;
        border-radius: 10px;
        /*color: #fff;*/
    }
    /*.calendar td.selected.red .td-box {*/
    /*border: 2px solid #ea6151;*/
    /*border-radius: 10px;*/
    /*!*color: #fff;*!*/
    /*}*/
    /*.calendar td.selected .text {*/
    /*color: white;*/
    /*}*/
    /**/
