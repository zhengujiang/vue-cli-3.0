<template>
  <div id="team-team-collect-item" class="team-team-collect-item">
    <div class="title">
    ...
    <div class="my-box">
      <!--<div class="contents" :style="{height: contentsHeight+'px'}">-->
      ...
      <!--<div class="listContent" :style="{height: listContHeight}">-->
      ...
      <div class="collectList" id="cat">
        ...
        <!--</div>-->
        <!--</div>-->
        <div id="wrapper" v-if="!loadContent" :style="{height: contentsHeight + 'px'}" v-loading="loadingInfo">
        ...
        <div v-if="!loadContent">
          <div class="center pagination">
            <el-pagination background layout="prev, pager, next" :current-page="pageNum" :total="collectTotal"
                           :page-size="listRows" @current-change="pageChange"></el-pagination>
          </div>
        </div>
    ...
    methods: {
      ...
      resizeHeight() {
        this.$nextTick(() => {
          ...
          this.contentsHeight = parseInt(windowH - 45 - 70); // 54 title 高度
          console.log(this.contentsHeight + 'contentsHeight');
          this.listContHeight = parseInt(this.contentsHeight) + 'px'; // 70 是底部确认框的高度； 80 输入框的高度
          console.log('height', this.listContHeight);
        });
      },
      getTeamDefault() {
        this.userInfo = window.JSON.parse(this.$cookie.get('userInfo'));
      ...
      contentStyle() {
        var cat = document.querySelector('#cat').clientHeight
        var wrap = document.querySelector('#wrapper');
        // console.log(cat, wrap);
