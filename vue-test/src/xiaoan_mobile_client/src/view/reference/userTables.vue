  ...
  export default {
    ...
    data() {
      return {
        ...
        warningHttp: false,
        waringBtn: '前往完善',
        waringText: '本功能仅适用于沪深上市公司，用户可在个人中心完善公司信息！',
        companycode: "",
        userInfo: {}
      }
    },
    ...
    created() {
      ...
      if (this.$cookie.isLogin()) {
        this.UserHome();
        this.$MTAmethod.mtaClick('a6ha223ea9v7m6fr', {'6vpd33aq59': 'true'});
      } else {
    ...
    mounted() {
      ...
      /*todo
       * */
      var adverttitle = "秒查披露权限，点击体验“快”感！";
    ...
    methods: {
          ...
          if (res.data.returnCode == 1) {
            ...
            if (this.companycode !== "") {
              ...
              if (res.data.returnObject.level == 0) {
                ...
                // 内部用户
                this.$router.replace({path: '/searchPower'});
              } else {
      ...
      choiceItem(index) {
        ...
        if (this.unitName == "万元") {
          $("table").css({'table-layout': 'fixed'})
          $("td").css({'word-wrap': 'break-word', 'overflow': 'auto'})
          /*nowrap  inherit*/
          $("td:first-child").css({'width': '25%!important'}).siblings().css({'width': '37.5%!important'})
          $(".listContent").eq(2).find("td:first-child").css({
            'word-wrap': 'break-word',
