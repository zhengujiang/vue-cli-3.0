<template>
    <div class="xinhulist"  :class="{'xhqPadding':!isShowDesc}" @click="handleClick(item)">
...
<script>
  export default {
    ...
    methods: {
      ...
      contentClick(evt) {
        this.$router.push({path: '/xhAnswerDetaile', query: {questionId: evt.questionId, answerId: evt.answerId}})
      } */
    }
  }
</script>
