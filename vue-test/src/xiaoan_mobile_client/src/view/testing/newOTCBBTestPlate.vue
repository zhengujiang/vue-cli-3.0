    ...
    methods: {
      ...
      startQa() {
        ...
        if (this.isSelected.id == undefined) {
          this.$vux.toast.show({text: '请选择答题数', position: 'middle', type: 'text', width: 'auto', time: 2500});
        } else {
          this.$router.replace({path: "/newOTCBBTestingList", query: {entrance: 1, total: this.isSelected.number}});
        }
      }
    }
  }
