<template>
  <div id="enterpriseInvite">
    <!--<template v-if="advType=='xinhu'">-->
    <!--<img v-if="userInfo.enterpriseUser" class="bannerImg"-->
    <!--src="http://oss.in-hope.cn/enterpriseApply/d9f866b5468b4959a64a09ea11b55f65.jpg" alt=""-->
    <!--@click.prevent="bannerHandle">-->
    <!--<img v-else class="bannerImg" src="/static/img/law/law-banner.png" alt="" @click.prevent="bannerHandle">-->
    <!--</template>-->
    <!--<template v-else>-->
    <!--<img v-if="userInfo.enterpriseUser" class="bannerImg"-->
    <!--src="http://oss.in-hope.cn/enterpriseApply/d9f866b5468b4959a64a09ea11b55f65.jpg" alt=""-->
    ...
    <!--<img v-else class="bannerImg" src="/static/img/law/law-banner.png" alt="" @click.prevent="bannerHandle">-->
    <!--</template>-->
    <img class="bannerImg" :src="$image.banner.competition_b" alt="" @click.prevent="bannerHandle">
  ...
  export default {
    data() {
      return {
        ...
        /*kaitongimg: '/static/img/law/kaitong.jpg',
